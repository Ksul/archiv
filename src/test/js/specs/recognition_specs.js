...
describe("Test für Recognition", function() {
    ...
    it("testRecognize", function() {
        ...
        doc.properties.content.write("Zauberfrau Rechnung Nr 1001 Gesamtbetrag 200  Datum 14.02.2015");
        var rules =
            '<documentTypes                                                                                                                                                                                                                                                                                 ' +
            'xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"                                                                                                                                                                                                                                          ' +
            'xmlns:cm="http://www.alfresco.org/model/content/1.0"                                                                                                                                                                                                                                           ' +
            'xmlns:my="http://www.schulte.local/archiv"  xsi:noNamespaceSchemaLocation="doc.xsd" archivRoot="Archiv/" inBox="Archiv/Inbox" logBox="Archiv/Report" mandatory="cm:title,my:documentDate,my:person" unknownBox="Archiv/Unbekannt" errorBox="Archiv/Fehler"  duplicateBox="Archiv/Fehler/Doppelte" debugLevel="info" maxDebugLength="40"> ' +
    ...
    it("testUnknownDocument", function() {
        var iBox = companyhome.childByNamePath("Archiv/Inbox");
        var doc = iBox.createNode("WebScriptTest", "my:archivContent");
        doc.properties.content.write("Hansel Rechnung Nr 1001 Gesamtbetrag 200  Datum 14.02.2015");
        var rules =
            '<documentTypes                                                                                                                                                                                                                                                                                 ' +
            'xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"                                                                                                                                                                                                                                          ' +
            'xmlns:cm="http://www.alfresco.org/model/content/1.0"                                                                                                                                                                                                                                           ' +
